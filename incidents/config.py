"""Incident monitor configuration."""
import os
...
COLLECTOR_DISCOVERY_STALE_SECONDS = int(os.getenv("INCIDENT_DISCOVERY_STALE", "43200"))
LIVE_COLLECTOR_STALE_SECONDS = int(os.getenv("INCIDENT_LIVE_STALE", "900"))
FINALIZER_STALE_SECONDS = int(os.getenv("INCIDENT_FINALIZER_STALE", "3600"))
